...
const FOREST_LIGHT = {
  ...
  inputBg: '#EEF6EF',
  cardAlt: '#E8F3E9',
  overlay: 'rgba(10,20,13,0.55)',
  divider: 'rgba(22,101,52,0.08)',
  glass: 'rgba(255,255,255,0.70)',
  glassBorder: 'rgba(22,101,52,0.08)',
  glassStrong: 'rgba(255,255,255,0.85)',
  glassLight: 'rgba(22,101,52,0.03)',
  gradientStart: '#15803D',
  gradientEnd: '#14532D',
  onGradient: '#FFFFFF',
  onGradientMuted: 'rgba(255,255,255,0.8)',
...
const AMBER_LIGHT = {
  ...
  surface: 'rgba(194,65,12,0.04)',
  inputBg: '#FBEDE3',
  cardAlt: '#F7E5D8',
  overlay: 'rgba(24,15,10,0.55)',
  divider: 'rgba(194,65,12,0.08)',
  glass: 'rgba(255,255,255,0.70)',
  glassBorder: 'rgba(194,65,12,0.08)',
  glassStrong: 'rgba(255,255,255,0.85)',
  glassLight: 'rgba(194,65,12,0.03)',
  gradientStart: '#EA580C',
  gradientEnd: '#9A3412',
  onGradient: '#FFFFFF',
  onGradientMuted: 'rgba(255,255,255,0.8)',
...
const SLATE_LIGHT = {
  ...
  glass: 'rgba(255,255,255,0.70)',
  glassBorder: 'rgba(51,65,85,0.08)',
  glassStrong: 'rgba(255,255,255,0.85)',
  glassLight: 'rgba(51,65,85,0.03)',
  gradientStart: '#475569',
  gradientEnd: '#1E293B',
  onGradient: '#FFFFFF',
  onGradientMuted: 'rgba(255,255,255,0.8)',
...
const ROSE_LIGHT = {
  ...
  card: '#FFFFFF',
  text: '#2B0A1A',
  textSecondary: '#8A4A66',
  textTertiary: '#B97C97',
  success: '#16A34A',
  error: '#DC2626',
  warning: '#D97706',
  accent: '#0E7490',
  border: 'rgba(219,39,119,0.10)',
  surface: 'rgba(219,39,119,0.04)',
  inputBg: '#FCEEF5',
  cardAlt: '#F8E4EF',
  overlay: 'rgba(23,11,18,0.55)',
  divider: 'rgba(219,39,119,0.08)',
  glass: 'rgba(255,255,255,0.70)',
  glassBorder: 'rgba(219,39,119,0.08)',
  glassStrong: 'rgba(255,255,255,0.85)',
  glassLight: 'rgba(219,39,119,0.03)',
  gradientStart: '#EC4899',
  gradientEnd: '#BE185D',
  onGradient: '#FFFFFF',
  onGradientMuted: 'rgba(255,255,255,0.8)',
...
export const PALETTES = {
  ...
  forest: { key: 'forest', name: 'Forest Green', swatch: '#15803D', dark: FOREST_DARK, light: FOREST_LIGHT },
  amber: { key: 'amber', name: 'Sunset Amber', swatch: '#EA580C', dark: AMBER_DARK, light: AMBER_LIGHT },
  slate: { key: 'slate', name: 'Slate Graphite', swatch: '#475569', dark: SLATE_DARK, light: SLATE_LIGHT },
  rose: { key: 'rose', name: 'Vivid Rose', swatch: '#EC4899', dark: ROSE_DARK, light: ROSE_LIGHT },
};
